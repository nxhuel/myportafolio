    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 text-center">
        <div className="animate-fade-up" style={{ animationDelay: "0.2s" }}>
          <p className="text-primary font-mono text-sm mb-8 neon-text tracking-widest">
            $ whoami
          </p>
        </div>

        <h1
          className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold font-sans mb-4 animate-fade-up tracking-tight"
        ...
        <div
          className="h-10 mb-8 animate-fade-up"
        ...
        <p
          className="text-muted-foreground max-w-2xl mx-auto mb-12 text-base md:text-lg leading-relaxed animate-fade-up"
          style={{ animationDelay: "0.8s" }}
        >
          Enfocado en Diseñar y Construir sistemas backend robustos, APIs
          escalables y arquitecturas seguras. Enfocado en rendimiento, calidad
